...
const (
	...
	// FileEndpoint is the endpoint for downloading a file from Bale.
...
// FileID is an ID of a file already uploaded to Bale.
type FileID string
...
//
// This was renamed to BanChatMember in later versions of the Bale Bot API.
