...
func NewPoll(chatID int64, question string, options ...string) SendPollConfig {
	return SendPollConfig{
		...
		Question:    question,
		Options:     options,
		IsAnonymous: true, // This is Bale's default.
	}
}
...
// https://core.Bale.org/bots/webapps#validating-data-received-via-the-web-app
func ValidateWebAppData(token, BaleInitData string) (bool, error) {
	initData, err := url.ParseQuery(BaleInitData)
	if err != nil {
