...
The Bale Bot API has a few potentially unanticipated behaviors. Here are a
...
- When extracting text entities using offsets and lengths, characters can appear
  to be in incorrect positions. This is because Bale uses UTF16 lengths
  while Golang uses UTF8. It's possible to convert between the two, see
  [issue #231][issue-231] for more details.

[issue-231]: https://github.com/go-Bale-bot-api/Bale-bot-api/issues/231
...
- By default, bots only get updates directly addressed to them. If you need to
  ...
  effect. You can read more on the [Bale Bot API docs][api-docs].

[api-docs]: https://core.Bale.org/bots/faq#what-messages-will-my-bot-get
