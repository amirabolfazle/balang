...
type (
	...
	EncryptedPassportElement struct {
		...
		// Base64-encoded encrypted Bale Passport element data provided by
	...
	// authenticating EncryptedPassportElement. See the Bale Passport
	...
	// PersonalDetails https://core.Bale.org/passport#personaldetails
	...
	// IDDocumentData https://core.Bale.org/passport#iddocumentdata
