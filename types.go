...
// SentFrom returns the user who sent an update. Can be nil, if Bale did not provide information
...
// User represents a Bale user or bot.
type User struct {
	...
	// IsPremium true, if user has Bale Premium
	//
	// optional
...
type Message struct {
	...
	// PassportData is a Bale Passport data;
	//
	// optional
...
// Audio represents an audio file to be treated as music by the Bale clients.
type Audio struct {
...
type Contact struct {
	...
	// optional
	LastName string `json:"last_name,omitempty"`
	// UserID contact's user identifier in Bale
	//
	// optional
...
// ReplyKeyboardRemove Upon receiving a message with this object, Bale
...
type InlineKeyboardButton struct {
	...
	// used as a replacement for the Bale Login Widget
	//
	// optional
...
// Bale Login Widget when the user is coming from Bale. All the user
...
// ForceReply when receiving a message with this object, Bale clients will
...
type BaseInputMedia struct {
	...
	// that exists on the Bale servers (recommended),
	// pass an HTTP URL for Bale to get a file from the Internet,
	...
	// (https://core.Bale.org/bots/api#formatting-options).
	//
	// optional
...
type WebhookInfo struct {
	...
	// happened when trying to synchronize available updates with Bale datacenters.
...
type LabeledPrice struct {
	...
	// (https://core.Bale.org/bots/payments/currencies.json),
...
type Invoice struct {
	...
	// (see https://core.Bale.org/bots/payments#supported-currencies)
	Currency string `json:"currency"`
...
type SuccessfulPayment struct {
	...
	// BalePaymentChargeID Bale payment identifier
	BalePaymentChargeID string `json:"Bale_payment_charge_id"`
