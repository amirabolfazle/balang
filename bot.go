...
//
// It requires a token, provided by @BotFather on Bale and API endpoint.
...
// SetAPIEndpoint changes the Bale Bot API endpoint used by the instance.
...
func (bot *BotAPI) UploadFiles(endpoint string, params Params, files []RequestFile) (*APIResponse, error) {
	...
	// https://github.com/go-Bale-bot-api/Bale-bot-api/issues/354#issuecomment-663856473
	go func() {
		defer w.Close()
		defer m.Close()
...
// Request sends a Chattable to Bale, and returns the APIResponse.
...
// Send will send a Chattable item to Bale and provides the
// returned Message.
...
//
// See https://core.Bale.org/bots/api#making-requests-when-getting-updates
// for details.
...
// EscapeText takes an input text and escape Bale markup symbols.
